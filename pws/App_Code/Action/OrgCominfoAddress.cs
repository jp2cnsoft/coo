...
namespace Seika.COO.Action
{
    ...
    /// 取得公司地址信息
    /// </summary>
    public class OrgCominfoAddress : ActionPageBase
    {
        public override DataSet Run(DBConnect sql, DataSet ds, String[] oparms)
        {
            ...
            cds.Tables.Add(cmdt.GetCloneTable(ma_cominfo.GetComInfoAddress(registid, m_session.Page_UICultureID), "MA_COMINFO"));
            //返回结果集
            return cds;
        }
    }
