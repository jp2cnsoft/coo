...
namespace ColorPickerTest
{
    ...
    public class ColorPicker : Control, IPostBackDataHandler
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            opendialogscript += "        colorpickerdiv.style.top=190 + 'px';\n";
            opendialogscript += "        colorpickerdiv.style.left=443 + 'px';\n";
            opendialogscript += "    }\n";
            ...
            colorpickerdiv += "     .colorpickertable{width:170px;}\n";
            colorpickerdiv += "     .colorpickerbutton{width:25px;border:1px solid #999;cursor:hand;}\n";
            colorpickerdiv += "</style>\n";

            colorpickerdiv += "<div id=\"colorpicker\">";
            colorpickerdiv += "     <table class=\"colorpickertable\" cellpadding=\"0\" cellspacing=\"0\" onclick=\"javascript:ColorPickerOnColorClick(event);\">";
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            html += "<input style=\"background-color:" + SelectedHexValue + ";width:"+this._width+"px;height:"+this._height+"px;color:" + SelectedHexValue + ";\" class=\"colorpickerbutton\" " + onclicker + " readonly=\"true\" class=\"lookupmodalvalue\" type=\"text\" name=\"" + this.UniqueID + "\" value=\"" + SelectedHexValue + "\" title=\"选取颜色!\">";
            output.Write(html);
        }
